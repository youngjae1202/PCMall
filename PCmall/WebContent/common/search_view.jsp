...
%>
		<table width=1300 border=0 cellpadding=0 cellspacing=0 bgcolor=ffffff>
			<tr>
				<td align=center bgcolor=black height=25><font color=white><b>제품 카테고리</b></font></td>
			</tr>
			<tr><td height=5></td></tr>
		</table>
		<table border=0 cellpadding=0 cellspacing=1 width=800 bgcolor=#CCD6DD>
			<tr bgcolor=#eff4f8 align=center> 
				<td height=30 align=center bgcolor=#CCD6DD>&nbsp;상품이미지</td>
				<td height=30 align=center bgcolor=#CCD6DD>&nbsp;상품명</td>
				<td height=30 align=center bgcolor=#CCD6DD>&nbsp;가격</td>
			</tr>
<%
			while(rs.next()) {
				id=rs.getInt(1);
...
%>
			<tr bgcolor="edf5fe"> 
				...
				<td align=center height=30>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../product/product.jsp?i=<%= id%>"> <%=name%></a></td>
				<c:set var="fmtPrice" value="<%=price%>"/>
				<td align=center height=30>&nbsp;<fmt:formatNumber value="${fmtPrice }" pattern="#,###" />&nbsp;원</td>			</tr>
<%	
			}
			rs.close();
			rs1.close();
