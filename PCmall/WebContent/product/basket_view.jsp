...
%>
<br>
<table border=1 cellpadding=0 cellspacing=0 width=1300 align=center>
	<tr bgcolor=#7aaad5>
		<td width=550 height=30 align=middle bgcolor=black><font size=3 color=white><b><%=pid%>&nbsp;님의 장바구니입니다.</b></font></td>
	</tr>
</table>

<table border=1 cellpadding=0 cellspacing=3 width=800  align=center>
	<tr height=23> 
		<th bgcolor="#CCD6DD"><font color="#ffffff" >상품명</font></th>
		<th  bgcolor="#CCD6DD"><font color="#ffffff">수량</font></th>
		<th  bgcolor="#CCD6DD"><font color="#ffffff">판매가</font></th>
		<th  bgcolor="#CCD6DD"><font color="#ffffff"> 합계금액</font></th>
		<th  bgcolor="#CCD6DD"><font color="#ffffff">취소</font></th>
	</tr>
<%
	while(rs.next()) {
		id=rs.getInt(1);
...
%>
	...
	<form method="post" action="basket_modify.jsp?productnum=<%= id %>&<%=number%>"> 
		<td  bgcolor="white"><a href="product.jsp?i=<%= id %>">&nbsp;<%=name%></a></td>
