...
<table class="table table-bordered">
		<tr>
			<td align=center bgcolor=white ><font size=3 ><b>제 품 게 시 판</b></font></td>
		</tr>
	</table>
	<br>
...
<%
	try{ 
		...
		String sql = "select id, code, price, company_id, photo, ";
		sql = sql + " to_char(cdate,'yy-mm-dd')"; 
		sql = sql + " from product order by id";
